...
import com.example.noteroom.ViewModelFactory
import com.example.noteroom.database.Note
import com.example.noteroom.databinding.ActivityNoteAddUpdateBinding
import com.example.noteroom.helper.DataHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            R.id.action_delete -> showsAlertDialog(ALERT_DIALOG_DELETE)
            android.R.id.home -> showsAlertDialog(ALERT_DIALOG_CLOSE)
        }
        return super.onOptionsItemSelected(item)
    }

    override fun onBackPressed() {
        showsAlertDialog(ALERT_DIALOG_CLOSE)
    }
    ...
    private fun showsAlertDialog(type: Int){
